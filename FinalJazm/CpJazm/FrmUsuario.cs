...
namespace CpJazm
{
    public partial class FrmUsuario : Form
    {
        ...
        private bool validar()
        {
            ...
            {
                erpTitulo.SetError(txtUsuario, "El campo titulo es obligatorio");
                esValido = false;
            }
            if (string.IsNullOrEmpty(txtClave.Text))
            {
                erpSinopsis.SetError(txtClave, "El campo Sinopsis es obligatorio");
                esValido = false;
            }
            if (string.IsNullOrEmpty(txtRol.Text))
            {
                erpSinopsis.SetError(txtClave, "El campo Direcccion es obligatorio");
                esValido = false;
            }
